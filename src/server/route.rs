...
pub async fn route(
    ...
    let res = match (req.method(), req.uri().path(), req.uri().query()) {
        ...
        (&Method::GET, "/v1/waterfalls", Some(query)) => {
            ...
            handle_waterfalls_req(state, inputs, WithTip::No, false, request_id).await
        }
        (&Method::GET, "/v2/waterfalls", Some(query)) => {
            ...
            handle_waterfalls_req(state, inputs, WithTip::Hash, false, request_id).await
        }
        ...
        (&Method::GET, "/v1/waterfalls.cbor", Some(query)) => {
            ...
            handle_waterfalls_req(state, inputs, WithTip::No, true, request_id).await
        }
        (&Method::GET, "/v2/waterfalls.cbor", Some(query)) => {
            ...
            handle_waterfalls_req(state, inputs, WithTip::Hash, true, request_id).await
        }
        ...
        (&Method::GET, "/v4/waterfalls", Some(query)) => {
            ...
            handle_waterfalls_req(state, inputs, WithTip::All, false, request_id).await
        }
        (&Method::GET, "/v4/waterfalls.cbor", Some(query)) => {
            ...
            handle_waterfalls_req(state, inputs, WithTip::All, true, request_id).await
        }
